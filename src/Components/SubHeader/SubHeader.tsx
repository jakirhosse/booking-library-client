...
interface SubHeaderProps {
  title: string; // Explicitly define the type of the title prop
}

const SubHeader: FC<SubHeaderProps> = ({ title }) => {
  return (
    <div className="h-20 my-7 mx-9 md:h-52 rounded-md bg-gradient-to-r from-[#95d3a2] to-[#359fac] flex items-center justify-center relative">
