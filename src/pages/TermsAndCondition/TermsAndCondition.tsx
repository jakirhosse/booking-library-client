const TermsAndCondition = () => {
        return (
            <div className="lg:mx-64 md:px-24 px-12">
                ...
                <div className="text-xl">
                    ...
                    As-Is Basis: The Service is provided "as is" and "as available" without warranties of any kind, whether express or implied.
                    <p className="font-bold text-2xl my-3 pt-4">9. Limitation of Liability</p>
                    
    
                    No Liability for Consequential Damages: In no event shall Langmaster be liable for any indirect, consequential, special, incidental, or punitive damages.
                    <p className="font-bold text-2xl my-3 pt-4">10. Changes to Terms </p>
                    
                    Modification of Terms: We reserve the right to modify these Terms at any time. Any changes will be effective immediately upon posting.
                    ...
                    Entire Agreement: These Terms constitute the entire agreement between you and Langmaster regarding the use of the Service.
                    <p className="font-bold text-2xl my-3 pt-4">13. Contact Information</p>
                    
    
                    Questions or Concerns: If you have any questions or concerns about these Terms, please contact us at <b>langmaster50@gmail.com. </b>
    
                    Make sure to replace the placeholders with specific information related to your project. Always consult with a legal professional to ensure that these terms are legally sound and appropriate for your specific needs.
                    <p className="font-bold my-16">Last revised on September 15th, 2023</p>
                </div>
            </div>
        );
    };
