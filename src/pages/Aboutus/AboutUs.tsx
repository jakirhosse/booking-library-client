...
import img2 from "../../assets/assets/about-us-image/proud-young-lady-sitting-table-holding-document-showing-her-strength-office 1 (1).png";
import img3 from "../../assets/assets/about-us-image/playing-fool-spacious-terrace 1.png";
import manimg1 from "../../assets/assets/man.png.webp"
import manimg2 from "../../assets/assets/man.png.webp"
import manimg3 from "../../assets/assets/man.png.webp"
import manimg4 from "../../assets/assets/man.png.webp"
import manimg5 from "../../assets/assets/man.png.webp"
        ...
        <div className="my-10 grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-7">
          ...
          >
            <img
              ...
              alt=""
            />
            <h4 className="text-md font-bold mt-3">Md: jakir Hossain</h4>
            <p className="text-sm font-serif px-14">
              Worked as a Full stack web developer in this project
            </p>
          </div>
          ...
          >
            <img
              ...
              alt=""
            />
            <h4 className="text-md font-bold mt-3">Md: Dalim kazi</h4>
            <p className="text-sm font-serif px-14">
              Worked as a Full stack web developer in this project
            </p>
          </div>
          ...
          >
            <img
              ...
              alt=""
            />
            <h4 className="text-md font-bold mt-3">Khonkon</h4>
            <p className="text-sm font-serif px-14">
              Worked as a Full stack web developer in this project
            </p>
          </div>
          ...
          >
            <img
              ...
              alt=""
            />
            <h4 className="text-md font-bold mt-3"> Md: Sakil sheikh</h4>
            <p className="text-sm font-serif px-14">
              Worked as a Full stack web developer in this project
            </p>
          </div>
          ...
          >
            <img
              ...
              alt=""
            />
            <h4 className="text-md font-bold mt-3">MD:Juel Rana</h4>
