...
const SingleBook = () => {
  ...
  // Define selectedBook using useState, replace with actual data fetching logic
  const [selectedBook, setSelectedBook] = useState({
    bookId: "123",  // Example values, replace with real data
          ...
          >
            <div className="inline-block max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl w-full">
              <div className="flex justify-end">
                <AiFillCloseCircle className="px-2 pb-3 text-yellow-500 text-5xl cursor-pointer" />
              </div>
              ...
              <div className="flex justify-end mt-4">
                ...
                <button className="px-4 py-2 ml-4 border rounded">
                  Cancel
                </button>
              </div>
            </div>
